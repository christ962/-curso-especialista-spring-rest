...
public class SpringDocConfig {
    ...
    private static final String badRequestResponse = "BabRequestResponse";
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        new Tag().name("Formas de pagamentos").description("Gerencia as formas de pagamento"),
                        new Tag().name("Pedidos").description("Gerencia os pedidos"),
                        new Tag().name("Restaurante").description("Gerencia os restaurante"),
    ...
    private Map<String, Schema> gerarSchemas() {
        ...
        Map<String, Schema> problemObjectSchema = ModelConverters.getInstance().read(Problema.Object.class);
