...
public interface PedidoControllerOpenApi {
    ...
    @PageableParameter
    public PagedModel<PedidoResumoModel> pesquisar(@Parameter(hidden = true) PedidoFilter filter,
    ...
    public PedidoModel buscar(@Parameter(description = "Código de um pedido", example = "04813f77-79b5-11ec-9a17-0242ac1b0002",
